...
const SustainabilityHeader: React.FC = () => (
  ...
  >
    <div className="relative overflow-hidden rounded-xl shadow-xl">
      ...
      <div className="relative p-8 text-white z-10">
        <div className="max-w-3xl">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-6 flex items-start">
              <span className="bg-gradient-to-r from-green-100 to-emerald-200 bg-clip-text text-transparent drop-shadow-sm">
                サステナビリティ自己診断ツール
              </span>
            </h1>
            
            <p className="text-lg opacity-90 mb-8 leading-relaxed text-green-50">
      ...
      {/* Decorative elements */}
      <div className="absolute -bottom-16 -right-16 w-56 h-56 bg-teal-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
      <div className="absolute -top-10 -left-10 w-40 h-40 bg-green-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
    </div>
  </motion.section>
);
