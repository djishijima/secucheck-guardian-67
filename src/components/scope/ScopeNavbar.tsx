    ...
    <div className="mb-8">
      ...
      >
        ...
        <div className="flex flex-wrap gap-4">
          <Link to="/scope-one">
            <Button variant="default" className="bg-blue-600 hover:bg-blue-700 shadow-sm flex items-center gap-2">
              <LineChart className="h-4 w-4" />
              Scope 1
            </Button>
          </Link>
          <Link to="/scope-two">
            <Button variant="outline" className="bg-white hover:bg-blue-50 border-blue-200 text-blue-700 shadow-sm flex items-center gap-2">
          ...
          <div className="ml-auto">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button className="bg-green-600 hover:bg-green-700 font-semibold shadow-md">
                自社データ入力
              </Button>
            </motion.div>
          </div>
