...
const HeroSection: React.FC = () => (
  ...
  >
    <motion.div
      ...
      className="mb-8"
    >
      <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-50 to-emerald-50 rounded-full text-green-800 font-medium mb-6 shadow-sm border border-green-200">
        <Check className="h-4 w-4 text-green-600" />
        <span>持続可能な未来へのビジネス変革</span>
      </div>
      
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6 leading-tight">
        <span className="bg-gradient-to-r from-green-700 via-teal-600 to-emerald-700 bg-clip-text text-transparent">
          サステナブルDX診断サービス
        </span>
      </h1>
    ...
    >
      <div className="flex-1 bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
        ...
        <p className="text-gray-600">客観的な指標に基づいた現状分析と業界ベンチマークで、貴社の立ち位置を明確に把握できます。</p>
      </div>
      
      <div className="flex-1 bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
        <Lightbulb className="h-10 w-10 text-amber-500 mb-4" />
        <h3 className="text-lg font-semibold mb-2 text-gray-800">実践的提案</h3>
        <p className="text-gray-600">診断結果に基づいた具体的なアクションプランと段階的な改善ステップをご提供します。</p>
      </div>
    </motion.div>
  </motion.div>
);
